...
// Avatar — accepts pfpUrl from OpenSea, falls back to initial
function Avatar({
  address,
  tone,
  pfpUrl,
...
export default function ComparePage() {
  ...
  const validA = isLikelyValidInput(walletA);
  const validB = isLikelyValidInput(walletB);
  const canCompare = validA && validB;
                      ...
                      <div key={name} className="cc-bar-row">
                        ...
                        <div className="cc-bar-track-wrap">
                          <div className="cc-bar-track">
                            <div
                              className="cc-bar-fill cc-bar-a"
                              style={{ width: `${(totalA / max) * 100}%` }}
                            />
                          </div>
                          <div className="cc-bar-track">
                            <div
                              className="cc-bar-fill cc-bar-b"
                              style={{ width: `${(totalB / max) * 100}%` }}
                            />
                          </div>
                        </div>
              ...
              <section className="panel compare-section">
                ...
                {sharedCollections.length > 3 ? (
                  ...
                  >
                    {showMoreCollections
                      ? "Show less"
                      : `Show more (${sharedCollections.length - 3})`}
                  </button>
                ) : null}
              </section>
            )}
              ...
              <section className="panel compare-section">
                  ...
                  {sharedArtists
                    ...
                    .map(([name, bucket]) => (
                      <article key={name} className="panel-subtle compare-group-card">
                        <div className="compare-group-head">
                          <div className="compare-group-title-wrap">
                            <h3 className="compare-group-title compare-group-title-lower">
                              {name}
                            </h3>
                ...
                {sharedArtists.length > 3 ? (
                  ...
                  >
                    {showMoreArtists
                      ? "Show less"
                      : `Show more (${sharedArtists.length - 3})`}
                  </button>
                ) : null}
              </section>
            )}
                ...
                <article className="panel compare-wallet-card wallet-tone-a">
                  <div className="compare-wallet-top">
                    ...
                    <div className="compare-wallet-count">
                      <div className="compare-wallet-count-value compare-mono">
                        {data.walletA.totalNFTs}
                      </div>
                        ...
                        <div className="compare-bar-track">
                          <div className="compare-bar-side left">
                            <div
                              ...
                              style={{ width: `${Math.max(left, 0)}%` }}
                            />
                          </div>
                          <div className="compare-bar-side right">
                            <div
                              className="compare-bar-fill"
                              style={{ width: `${Math.max(right, 0)}%` }}
                            />
                          </div>
                        </div>
                      </div>
