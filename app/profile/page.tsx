            ...
            <header className="profile-panel profile-header-card">
              <div className="profile-id-top">
                <div className="profile-id-main">
                  <div className="profile-avatar-fallback" aria-hidden="true">{headerAvatarUrl ? <img src={headerAvatarUrl} alt={headerDisplayName} className="profile-avatar-img" /> : headerDisplayName.slice(0, 1).toUpperCase()}</div>
                  <div>
